...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, "Vou viajar para São Paulo. Abraços!", "Partiu viagem", LocalDate.parse("21/03/2018", formatter), maria);
        Post post2 = new Post(null, "Acordei feliz hoje!", "Bom dia", LocalDate.parse("23/03/2018", formatter), maria);
